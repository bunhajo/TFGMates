...
Por esta razón, daremos dos variantes del algoritmo de Back-propagation que se usan frecuentemente para acelerar su convergencia, la \textit{Técnica de $\eta$ Adaptable} y el \textit{Algoritmo de Resilient Back-propagation} de Martin Riedmiller (1994).
