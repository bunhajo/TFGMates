...
Sea $X$ una variable aleatoria en un espacio de probabilidad $(\Omega, \mathcal{F}, P)$. Sea $\mathcal{E}$ una sub $\sigma$-álgebra de $\mathcal{F}$, o sea, $\mathcal{E}$ una $\sigma$-álgebra y $\mathcal{E} \subset \mathcal{F}$.
