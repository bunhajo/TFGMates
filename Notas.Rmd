...
$$
y_j=f(\sum_{i=1}^{n-1} w_iI_i + \theta_j)=f(s) \quad (3)
$$
...
$$
y_j=f(\sum_{i=1}^{n} w_iI_i)=f(s) \quad (3)
$$

Si el ouput deseado es $d_j$, entonces de (1) tenemos
$$
\frac{\partial E}{\partial w_i} = \frac{\partial E}{\partial y_j}\frac{\partial y_j}{\partial w_i}
$$
$$
=-(d_j - y_j)f'(s)I_i
$$
